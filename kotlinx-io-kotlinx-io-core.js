(function (factory) {
  ...
  function write$default(source, startIndex, endIndex, $super) {
    ...
    var tmp;
    if ($super === VOID) {
      this.l16(source, startIndex, endIndex);
      tmp = Unit_instance;
    } else {
      tmp = $super.l16.call(this, source, startIndex, endIndex);
    }
    return tmp;
  }
  ...
  function Buffer() {
    this.y14_1 = null;
    this.z14_1 = null;
    this.a15_1 = new Long(0, 0);
  }
  protoOf(Buffer).e1 = function () {
    return this.a15_1;
  };
  protoOf(Buffer).b15 = function () {
    return this;
  };
  protoOf(Buffer).c15 = function () {
    return equalsLong(this.e1(), new Long(0, 0));
  };
  protoOf(Buffer).d15 = function (byteCount) {
  ...
  protoOf(Buffer).e15 = function (byteCount) {
    // Inline function 'kotlin.require' call
    if (!(compare(byteCount, new Long(0, 0)) >= 0)) {
  ...
  protoOf(Buffer).f15 = function () {
    ...
    var v = segment.o15();
    this.a15_1 = subtract(this.a15_1, new Long(1, 0));
    if (segmentSize === 1) {
      this.n15();
    }
    return v;
  };
  protoOf(Buffer).p15 = function () {
    var tmp0_elvis_lhs = this.y14_1;
    var tmp;
    if (tmp0_elvis_lhs == null) {
    ...
    var segmentSize = segment.e1();
    if (segmentSize < 2) {
      this.d15(new Long(2, 0));
      if (segmentSize === 0) {
        this.n15();
        return this.p15();
      }
      // Inline function 'kotlinx.io.and' call
      var tmp_0 = (this.f15() & 255) << 8;
      // Inline function 'kotlinx.io.and' call
      var tmp$ret$1 = this.f15() & 255;
      return toShort(tmp_0 | tmp$ret$1);
    }
    var v = segment.q15();
    this.a15_1 = subtract(this.a15_1, new Long(2, 0));
    if (segmentSize === 2) {
      this.n15();
    }
    return v;
  };
  protoOf(Buffer).r15 = function () {
    return Unit_instance;
  };
  protoOf(Buffer).s15 = function (out, startIndex, endIndex) {
    ...
    out.a15_1 = add(out.a15_1, remainingByteCount);
    var s = this.y14_1;
    while (compare(currentOffset, fromInt(ensureNotNull(s).i15_1 - s.h15_1 | 0)) >= 0) {
      currentOffset = subtract(currentOffset, fromInt(s.i15_1 - s.h15_1 | 0));
      s = s.l15_1;
    }
    while (compare(remainingByteCount, new Long(0, 0)) > 0) {
      var copy = ensureNotNull(s).t15();
      copy.h15_1 = copy.h15_1 + convertToInt(currentOffset) | 0;
      var tmp = copy;
      var tmp0 = copy.h15_1 + convertToInt(remainingByteCount) | 0;
      // Inline function 'kotlin.comparisons.minOf' call
      var b = copy.i15_1;
      tmp.i15_1 = Math.min(tmp0, b);
      // Inline function 'kotlinx.io.Buffer.pushSegment' call
      if (out.y14_1 == null) {
        out.y14_1 = copy;
        out.z14_1 = copy;
      } else if (false) {
        out.z14_1 = ensureNotNull(out.z14_1).u15(copy).v15();
        if (ensureNotNull(out.z14_1).m15_1 == null) {
          out.y14_1 = out.z14_1;
        }
      } else {
        out.z14_1 = ensureNotNull(out.z14_1).u15(copy);
      }
      remainingByteCount = subtract(remainingByteCount, fromInt(copy.i15_1 - copy.h15_1 | 0));
      currentOffset = new Long(0, 0);
      s = s.l15_1;
    }
  };
  protoOf(Buffer).w15 = function () {
    var result = this.e1();
    if (equalsLong(result, new Long(0, 0)))
      return new Long(0, 0);
    var tail = ensureNotNull(this.z14_1);
    if (tail.i15_1 < 8192 && tail.k15_1) {
      result = subtract(result, fromInt(tail.i15_1 - tail.h15_1 | 0));
    }
    return result;
  };
  protoOf(Buffer).x15 = function (position) {
    ...
    if (equalsLong(position, new Long(0, 0))) {
      return ensureNotNull(this.y14_1).y15(0);
    }
    $l$block_1: {
      // Inline function 'kotlinx.io.seek' call
      if (this.y14_1 == null) {
        var offset = new Long(-1, -1);
        return ensureNotNull(null).y15(convertToInt(subtract(position, offset)));
      }
      if (compare(subtract(this.e1(), position), position) < 0) {
        var s = this.z14_1;
        var offset_0 = this.e1();
        $l$loop: while (!(s == null) && compare(offset_0, position) > 0) {
          offset_0 = subtract(offset_0, fromInt(s.i15_1 - s.h15_1 | 0));
        ...
        return ensureNotNull(tmp0).y15(convertToInt(subtract(position, offset_1)));
      } else {
        var s_0 = this.y14_1;
        ...
        $l$loop_0: while (!(s_0 == null)) {
          ...
          var other = s_0.i15_1 - s_0.h15_1 | 0;
        ...
        return ensureNotNull(tmp0_1).y15(convertToInt(subtract(position, offset_3)));
      }
    }
  };
  protoOf(Buffer).r2 = function () {
    return this.z15(this.e1());
  };
  protoOf(Buffer).z15 = function (byteCount) {
    ...
    while (compare(remainingByteCount, new Long(0, 0)) > 0) {
      ...
      var b = head.i15_1 - head.h15_1 | 0;
      // Inline function 'kotlin.comparisons.minOf' call
      var b_0 = fromInt(b);
      var tmp$ret$3 = compare(tmp0, b_0) <= 0 ? tmp0 : b_0;
      var toSkip = convertToInt(tmp$ret$3);
      this.a15_1 = subtract(this.a15_1, fromInt(toSkip));
      remainingByteCount = subtract(remainingByteCount, fromInt(toSkip));
      head.h15_1 = head.h15_1 + toSkip | 0;
      if (head.h15_1 === head.i15_1) {
        this.n15();
      }
    }
  };
  protoOf(Buffer).a16 = function (sink, startIndex, endIndex) {
    ...
    s.b16(sink, startIndex, startIndex + toCopy | 0);
    this.a15_1 = subtract(this.a15_1, fromInt(toCopy));
    if (isEmpty(s)) {
      this.n15();
    }
    return toCopy;
  };
  protoOf(Buffer).c16 = function (sink, byteCount) {
    // Inline function 'kotlinx.io.checkByteCount' call
    // Inline function 'kotlin.require' call
    if (!(compare(byteCount, new Long(0, 0)) >= 0)) {
      var message = 'byteCount (' + byteCount.toString() + ') < 0';
    ...
    sink.d16(this, bytesWritten);
    return bytesWritten;
  };
  protoOf(Buffer).e16 = function (sink, byteCount) {
    // Inline function 'kotlinx.io.checkByteCount' call
    // Inline function 'kotlin.require' call
    if (!(compare(byteCount, new Long(0, 0)) >= 0)) {
      var message = 'byteCount (' + byteCount.toString() + ') < 0';
    ...
    sink.d16(this, byteCount);
  };
  protoOf(Buffer).f16 = function (sink) {
  ...
  protoOf(Buffer).h16 = function (minimumCapacity) {
    // Inline function 'kotlin.require' call
    ...
    if (this.z14_1 == null) {
      var result = SegmentPool_instance.k16();
      this.y14_1 = result;
      this.z14_1 = result;
      return result;
    }
    var t = ensureNotNull(this.z14_1);
    if ((t.i15_1 + minimumCapacity | 0) > 8192 || !t.k15_1) {
      var newTail = t.u15(SegmentPool_instance.k16());
      this.z14_1 = newTail;
      return newTail;
    }
    return t;
  };
  protoOf(Buffer).l16 = function (source, startIndex, endIndex) {
    // Inline function 'kotlinx.io.checkBounds' call
    ...
    while (currentOffset < endIndex) {
      ...
      var b = tail.m16();
      var toCopy = Math.min(tmp0, b);
      tail.n16(source, currentOffset, currentOffset + toCopy | 0);
      currentOffset = currentOffset + toCopy | 0;
    }
    var tmp = this;
    var tmp0_0 = this.a15_1;
    // Inline function 'kotlin.Long.plus' call
    var other = endIndex - startIndex | 0;
    tmp.a15_1 = add(tmp0_0, fromInt(other));
  };
  protoOf(Buffer).p16 = function (source, byteCount) {
    // Inline function 'kotlinx.io.checkByteCount' call
    // Inline function 'kotlin.require' call
    if (!(compare(byteCount, new Long(0, 0)) >= 0)) {
      var message = 'byteCount (' + byteCount.toString() + ') < 0';
    ...
    var remainingByteCount = byteCount;
    while (compare(remainingByteCount, new Long(0, 0)) > 0) {
      var read = source.c16(this, remainingByteCount);
  ...
  protoOf(Buffer).d16 = function (source, byteCount) {
    // Inline function 'kotlin.require' call
    if (!!(source === this)) {
      var message = 'source == this';
      throw IllegalArgumentException_init_$Create$(toString(message));
    }
    checkOffsetAndCount(source.a15_1, new Long(0, 0), byteCount);
    var remainingByteCount = byteCount;
    while (compare(remainingByteCount, new Long(0, 0)) > 0) {
      if (compare(remainingByteCount, fromInt(ensureNotNull(source.y14_1).e1())) < 0) {
        var tail = this.z14_1;
        var tmp;
        if (!(tail == null) && tail.k15_1) {
          var tmp0 = remainingByteCount;
          // Inline function 'kotlin.Long.plus' call
          var other = tail.i15_1;
          var tmp0_0 = add(tmp0, fromInt(other));
          // Inline function 'kotlin.Long.minus' call
          var other_0 = tail.q16() ? 0 : tail.h15_1;
        ...
        if (tmp) {
          ensureNotNull(source.y14_1).s16(tail, convertToInt(remainingByteCount));
          source.a15_1 = subtract(source.a15_1, remainingByteCount);
          this.a15_1 = add(this.a15_1, remainingByteCount);
          return Unit_instance;
        } else {
          source.y14_1 = ensureNotNull(source.y14_1).r16(convertToInt(remainingByteCount));
        }
      }
      var segmentToMove = ensureNotNull(source.y14_1);
      var movedByteCount = fromInt(segmentToMove.e1());
      source.y14_1 = segmentToMove.t16();
      if (source.y14_1 == null) {
        source.z14_1 = null;
      }
      // Inline function 'kotlinx.io.Buffer.pushSegment' call
      if (this.y14_1 == null) {
        this.y14_1 = segmentToMove;
        this.z14_1 = segmentToMove;
      } else if (true) {
        this.z14_1 = ensureNotNull(this.z14_1).u15(segmentToMove).v15();
        if (ensureNotNull(this.z14_1).m15_1 == null) {
          this.y14_1 = this.z14_1;
        }
      } else {
        this.z14_1 = ensureNotNull(this.z14_1).u15(segmentToMove);
      }
      source.a15_1 = subtract(source.a15_1, movedByteCount);
      this.a15_1 = add(this.a15_1, movedByteCount);
      remainingByteCount = subtract(remainingByteCount, movedByteCount);
    }
  };
  protoOf(Buffer).u16 = function (source) {
    var totalBytesRead = new Long(0, 0);
    $l$loop: while (true) {
      var readCount = source.c16(this, new Long(8192, 0));
  ...
  protoOf(Buffer).v16 = function (byte) {
    this.h16(1).w16(byte);
    this.a15_1 = add(this.a15_1, new Long(1, 0));
  };
  protoOf(Buffer).x16 = function (short) {
    this.h16(2).y16(short);
    this.a15_1 = add(this.a15_1, new Long(2, 0));
  };
  protoOf(Buffer).t3 = function () {
    return Unit_instance;
  };
  protoOf(Buffer).toString = function () {
    ...
    while (!(curr == null)) {
      ...
      while (bytesWritten < len && idx < segment.e1()) {
        ...
        var b_0 = tmp0.z16(segment, _unary__edvuaz);
  ...
  protoOf(Buffer).n15 = function () {
    var oldHead = ensureNotNull(this.y14_1);
    var nextHead = oldHead.l15_1;
    this.y14_1 = nextHead;
    if (nextHead == null) {
      this.z14_1 = null;
    } else {
    ...
    oldHead.l15_1 = null;
    SegmentPool_instance.a17(oldHead);
  };
  protoOf(Buffer).b17 = function () {
    var oldTail = ensureNotNull(this.z14_1);
    var newTail = oldTail.m15_1;
    this.z14_1 = newTail;
    if (newTail == null) {
      this.y14_1 = null;
    } else {
    ...
    oldTail.m15_1 = null;
    SegmentPool_instance.a17(oldTail);
  };
    ...
    $l$block_1: {
      ...
      if (compare(subtract(_this__u8e3s4.e1(), startIndex), startIndex) < 0) {
        ...
        do {
          ...
          segment_0 = segment_0.l15_1;
        }
         while (!(segment_0 == null) && compare(offset_1, endOffset) < 0);
        return new Long(-1, -1);
      } else {
        var s_0 = _this__u8e3s4.y14_1;
        var offset_2 = new Long(0, 0);
        $l$loop_0: while (!(s_0 == null)) {
          var tmp0_4 = offset_2;
          // Inline function 'kotlin.Long.plus' call
          var other_1 = s_0.i15_1 - s_0.h15_1 | 0;
  ...
  function readByteString(_this__u8e3s4, byteCount) {
    return UnsafeByteStringOperations_instance.x14(readByteArray_0(_this__u8e3s4, byteCount));
  }
  ...
  function PeekSource(upstream) {
    this.c17_1 = upstream;
    this.d17_1 = this.c17_1.b15();
    this.e17_1 = this.d17_1.y14_1;
    var tmp = this;
    var tmp0_safe_receiver = this.d17_1.y14_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.h15_1;
    tmp.f17_1 = tmp1_elvis_lhs == null ? -1 : tmp1_elvis_lhs;
    this.g17_1 = false;
    this.h17_1 = new Long(0, 0);
  }
  protoOf(PeekSource).c16 = function (sink, byteCount) {
    // Inline function 'kotlin.check' call
    if (!!this.g17_1) {
    ...
    // Inline function 'kotlin.check' call
    if (!(this.e17_1 == null || (this.e17_1 === this.d17_1.y14_1 && this.f17_1 === ensureNotNull(this.d17_1.y14_1).h15_1))) {
    ...
    if (!this.c17_1.e15(tmp$ret$7))
      return new Long(-1, -1);
    if (this.e17_1 == null && !(this.d17_1.y14_1 == null)) {
      this.e17_1 = this.d17_1.y14_1;
      this.f17_1 = ensureNotNull(this.d17_1.y14_1).h15_1;
    }
    // Inline function 'kotlin.comparisons.minOf' call
    var b = subtract(this.d17_1.e1(), this.h17_1);
    var toCopy = compare(byteCount, b) <= 0 ? byteCount : b;
    this.d17_1.s15(sink, this.h17_1, add(this.h17_1, toCopy));
    this.h17_1 = add(this.h17_1, toCopy);
    return toCopy;
  };
  protoOf(PeekSource).t3 = function () {
    this.g17_1 = true;
  };
  function RealSource(source) {
    this.i17_1 = source;
    this.j17_1 = false;
    this.k17_1 = new Buffer();
  }
  protoOf(RealSource).b15 = function () {
    return this.k17_1;
  };
  protoOf(RealSource).c16 = function (sink, byteCount) {
    ...
    if (equalsLong(this.k17_1.e1(), new Long(0, 0))) {
      var read = this.i17_1.c16(this.k17_1, new Long(8192, 0));
      if (equalsLong(read, new Long(-1, -1)))
        return new Long(-1, -1);
    }
    // Inline function 'kotlin.comparisons.minOf' call
    ...
    return this.k17_1.c16(sink, toRead);
  };
  protoOf(RealSource).c15 = function () {
    // Inline function 'kotlinx.io.RealSource.checkNotClosed' call
    // Inline function 'kotlin.check' call
    if (!!this.j17_1) {
      var message = 'Source is closed.';
    ...
    return this.k17_1.c15() && equalsLong(this.i17_1.c16(this.k17_1, new Long(8192, 0)), new Long(-1, -1));
  };
  protoOf(RealSource).d15 = function (byteCount) {
    if (!this.e15(byteCount))
      throw EOFException_init_$Create$_0("Source doesn't contain required number of bytes (" + byteCount.toString() + ').');
  };
  protoOf(RealSource).e15 = function (byteCount) {
    // Inline function 'kotlinx.io.RealSource.checkNotClosed' call
    // Inline function 'kotlin.check' call
    if (!!this.j17_1) {
      var message = 'Source is closed.';
    ...
    while (compare(this.k17_1.e1(), byteCount) < 0) {
      if (equalsLong(this.i17_1.c16(this.k17_1, new Long(8192, 0)), new Long(-1, -1)))
        return false;
    }
    return true;
  };
  protoOf(RealSource).f15 = function () {
    this.d15(new Long(1, 0));
    return this.k17_1.f15();
  };
  protoOf(RealSource).a16 = function (sink, startIndex, endIndex) {
    // Inline function 'kotlinx.io.checkBounds' call
    var size = sink.length;
    checkBounds(fromInt(size), fromInt(startIndex), fromInt(endIndex));
    if (equalsLong(this.k17_1.e1(), new Long(0, 0))) {
    ...
    return this.k17_1.a16(sink, startIndex, startIndex + toRead | 0);
  };
  protoOf(RealSource).e16 = function (sink, byteCount) {
    try {
      this.d15(byteCount);
    } catch ($p) {
      if ($p instanceof EOFException) {
        var e = $p;
        sink.d16(this.k17_1, this.k17_1.e1());
        throw e;
      } else {
        throw $p;
      }
    }
    this.k17_1.e16(sink, byteCount);
  };
  protoOf(RealSource).f16 = function (sink) {
    var totalBytesWritten = new Long(0, 0);
    while (!equalsLong(this.i17_1.c16(this.k17_1, new Long(8192, 0)), new Long(-1, -1))) {
      var emitByteCount = this.k17_1.w15();
      if (compare(emitByteCount, new Long(0, 0)) > 0) {
        totalBytesWritten = add(totalBytesWritten, emitByteCount);
        sink.d16(this.k17_1, emitByteCount);
      }
    }
    if (compare(this.k17_1.e1(), new Long(0, 0)) > 0) {
      totalBytesWritten = add(totalBytesWritten, this.k17_1.e1());
      sink.d16(this.k17_1, this.k17_1.e1());
    }
    return totalBytesWritten;
  };
  protoOf(RealSource).p15 = function () {
    this.d15(new Long(2, 0));
    return this.k17_1.p15();
  };
  ...
  protoOf(RealSource).t3 = function () {
    if (this.j17_1)
      return Unit_instance;
    this.j17_1 = true;
    this.i17_1.t3();
  ...
  protoOf(RealSource).toString = function () {
    return 'buffered(' + toString(this.i17_1) + ')';
  };
  function Segment_init_$Init$($this) {
    Segment.call($this);
    $this.g15_1 = new Int8Array(8192);
    $this.k15_1 = true;
    $this.j15_1 = null;
    return $this;
  }
  ...
  protoOf(Segment).q16 = function () {
    var tmp0_safe_receiver = this.j15_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.o17();
    return tmp1_elvis_lhs == null ? false : tmp1_elvis_lhs;
  };
  protoOf(Segment).t15 = function () {
    var tmp0_elvis_lhs = this.j15_1;
    var tmp;
    if (tmp0_elvis_lhs == null) {
      // Inline function 'kotlin.also' call
      var this_0 = SegmentPool_instance.p17();
      this.j15_1 = this_0;
      tmp = this_0;
    } else {
      tmp = tmp0_elvis_lhs;
    ...
    var t = tmp;
    var tmp_0 = this.h15_1;
    var tmp_1 = this.i15_1;
    // Inline function 'kotlin.also' call
    t.q17();
    return Segment_init_$Create$_0(this.g15_1, tmp_0, tmp_1, t, false);
  };
  protoOf(Segment).t16 = function () {
    var result = this.l15_1;
    if (!(this.m15_1 == null)) {
      ensureNotNull(this.m15_1).l15_1 = this.l15_1;
    }
    if (!(this.l15_1 == null)) {
      ensureNotNull(this.l15_1).m15_1 = this.m15_1;
    }
    this.l15_1 = null;
    this.m15_1 = null;
    return result;
  };
  protoOf(Segment).u15 = function (segment) {
    segment.m15_1 = this;
    segment.l15_1 = this.l15_1;
    if (!(this.l15_1 == null)) {
      ensureNotNull(this.l15_1).m15_1 = segment;
    }
    this.l15_1 = segment;
    return segment;
  };
  protoOf(Segment).r16 = function (byteCount) {
    // Inline function 'kotlin.require' call
    if (!(byteCount > 0 && byteCount <= (this.i15_1 - this.h15_1 | 0))) {
    ...
    if (byteCount >= 1024) {
      ...
      prefix = SegmentPool_instance.k16();
      var tmp0 = this.g15_1;
      var tmp2 = prefix.g15_1;
      var tmp5 = this.h15_1;
      // Inline function 'kotlin.collections.copyInto' call
      var endIndex = this.h15_1 + byteCount | 0;
    ...
    prefix.i15_1 = prefix.h15_1 + byteCount | 0;
    this.h15_1 = this.h15_1 + byteCount | 0;
    if (!(this.m15_1 == null)) {
      ensureNotNull(this.m15_1).u15(prefix);
    } else {
      prefix.l15_1 = this;
      this.m15_1 = prefix;
    }
  ...
  protoOf(Segment).v15 = function () {
    ...
    if (!ensureNotNull(this.m15_1).k15_1)
      return this;
    var byteCount = this.i15_1 - this.h15_1 | 0;
    var availableByteCount = (8192 - ensureNotNull(this.m15_1).i15_1 | 0) + (ensureNotNull(this.m15_1).q16() ? 0 : ensureNotNull(this.m15_1).h15_1) | 0;
    if (byteCount > availableByteCount)
      return this;
    var predecessor = this.m15_1;
    this.s16(ensureNotNull(predecessor), byteCount);
    var successor = this.t16();
    // Inline function 'kotlin.check' call
    if (!(successor == null)) {
      throw IllegalStateException_init_$Create$('Check failed.');
    }
    SegmentPool_instance.a17(this);
    return predecessor;
  };
  protoOf(Segment).w16 = function (byte) {
    var _unary__edvuaz = this.i15_1;
    this.i15_1 = _unary__edvuaz + 1 | 0;
    this.g15_1[_unary__edvuaz] = byte;
  };
  protoOf(Segment).y16 = function (short) {
    var data = this.g15_1;
    var limit = this.i15_1;
  ...
  protoOf(Segment).o15 = function () {
    var _unary__edvuaz = this.h15_1;
    this.h15_1 = _unary__edvuaz + 1 | 0;
    return this.g15_1[_unary__edvuaz];
  };
  protoOf(Segment).q15 = function () {
    var data = this.g15_1;
    var pos = this.h15_1;
  ...
  protoOf(Segment).s16 = function (sink, byteCount) {
    // Inline function 'kotlin.check' call
    if (!sink.k15_1) {
      var message = 'only owner can write';
      throw IllegalStateException_init_$Create$(toString(message));
    }
    if ((sink.i15_1 + byteCount | 0) > 8192) {
      if (sink.q16())
        throw IllegalArgumentException_init_$Create$_0();
      if (((sink.i15_1 + byteCount | 0) - sink.h15_1 | 0) > 8192)
        throw IllegalArgumentException_init_$Create$_0();
      var tmp0 = sink.g15_1;
      var tmp2 = sink.g15_1;
      var tmp5 = sink.h15_1;
      // Inline function 'kotlin.collections.copyInto' call
      var endIndex = sink.i15_1;
      // Inline function 'kotlin.js.unsafeCast' call
      // Inline function 'kotlin.js.asDynamic' call
      var tmp = tmp0;
      // Inline function 'kotlin.js.unsafeCast' call
      // Inline function 'kotlin.js.asDynamic' call
      arrayCopy(tmp, tmp2, 0, tmp5, endIndex);
      sink.i15_1 = sink.i15_1 - sink.h15_1 | 0;
      sink.h15_1 = 0;
    }
    var tmp0_0 = this.g15_1;
    var tmp2_0 = sink.g15_1;
    var tmp4 = sink.i15_1;
    var tmp6 = this.h15_1;
    // Inline function 'kotlin.collections.copyInto' call
    var endIndex_0 = this.h15_1 + byteCount | 0;
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    var tmp_0 = tmp0_0;
    // Inline function 'kotlin.js.unsafeCast' call
    ...
    sink.i15_1 = sink.i15_1 + byteCount | 0;
    this.h15_1 = this.h15_1 + byteCount | 0;
  };
  protoOf(Segment).b16 = function (dst, dstStartOffset, dstEndOffset) {
    var len = dstEndOffset - dstStartOffset | 0;
    var tmp0 = this.g15_1;
    var tmp6 = this.h15_1;
    // Inline function 'kotlin.collections.copyInto' call
    var endIndex = this.h15_1 + len | 0;
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    var tmp = tmp0;
    // Inline function 'kotlin.js.unsafeCast' call
    ...
    this.h15_1 = this.h15_1 + len | 0;
  };
  protoOf(Segment).n16 = function (src, srcStartOffset, srcEndOffset) {
    var tmp2 = this.g15_1;
    // Inline function 'kotlin.collections.copyInto' call
    var destinationOffset = this.i15_1;
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    var tmp = src;
    // Inline function 'kotlin.js.unsafeCast' call
    ...
    this.i15_1 = this.i15_1 + (srcEndOffset - srcStartOffset | 0) | 0;
  };
  protoOf(Segment).e1 = function () {
    return this.i15_1 - this.h15_1 | 0;
  };
  protoOf(Segment).m16 = function () {
    return this.g15_1.length - this.i15_1 | 0;
  };
  protoOf(Segment).r17 = function (readOnly) {
    return this.g15_1;
  };
  protoOf(Segment).y15 = function (index) {
    return this.g15_1[this.h15_1 + index | 0];
  };
  protoOf(Segment).s17 = function (index, value) {
    this.g15_1[this.i15_1 + index | 0] = value;
  };
  protoOf(Segment).t17 = function (index, b0, b1) {
    var d = this.g15_1;
    var l = this.i15_1;
    d[l + index | 0] = b0;
    d[(l + index | 0) + 1 | 0] = b1;
  };
  protoOf(Segment).u17 = function (index, b0, b1, b2) {
    var d = this.g15_1;
    var l = this.i15_1;
    d[l + index | 0] = b0;
    d[(l + index | 0) + 1 | 0] = b1;
  ...
  protoOf(Segment).v17 = function (index, b0, b1, b2, b3) {
    var d = this.g15_1;
    var l = this.i15_1;
    d[l + index | 0] = b0;
    d[(l + index | 0) + 1 | 0] = b1;
  ...
  function indexOf_0(_this__u8e3s4, byte, startOffset, endOffset) {
    ...
    var p = _this__u8e3s4.h15_1;
    var data = _this__u8e3s4.r17(true);
  ...
  protoOf(AlwaysSharedCopyTracker).o17 = function () {
    return true;
  };
  protoOf(AlwaysSharedCopyTracker).q17 = function () {
    return Unit_instance;
  };
  ...
  function indexOf_1(_this__u8e3s4, byte, startIndex, endIndex) {
    ...
    $l$loop: while (true) {
      ...
      if (compare(offset, endIndex) < 0) {
        ...
        tmp_0 = _this__u8e3s4.e15(tmp$ret$2);
      } else {
        tmp_0 = false;
      }
      if (!tmp_0) {
  ...
  function readByteArrayImpl(_this__u8e3s4, size) {
    ...
    if (size === -1) {
      ...
      while (compare(_this__u8e3s4.b15().e1(), new Long(2147483647, 0)) < 0 && _this__u8e3s4.e15(fetchSize)) {
        // Inline function 'kotlin.Long.times' call
        var this_0 = fetchSize;
        fetchSize = multiply(this_0, fromInt(2));
      }
      // Inline function 'kotlin.check' call
      if (!(compare(_this__u8e3s4.b15().e1(), new Long(2147483647, 0)) < 0)) {
        var message = "Can't create an array of size " + _this__u8e3s4.b15().e1().toString();
        throw IllegalStateException_init_$Create$(toString(message));
      }
      arraySize = convertToInt(_this__u8e3s4.b15().e1());
    } else {
      _this__u8e3s4.d15(fromInt(size));
    }
    var array = new Int8Array(arraySize);
    readTo(_this__u8e3s4.b15(), array);
    return array;
  }
  function readTo(_this__u8e3s4, sink, startIndex, endIndex) {
    ...
    while (offset < endIndex) {
      var bytesRead = _this__u8e3s4.a16(sink, offset, endIndex);
      if (bytesRead === -1) {
  ...
  function readString(_this__u8e3s4, byteCount) {
    _this__u8e3s4.d15(byteCount);
    return commonReadUtf8(_this__u8e3s4.b15(), byteCount);
  }
  function readString_0(_this__u8e3s4) {
    _this__u8e3s4.e15(new Long(-1, 2147483647));
    return commonReadUtf8(_this__u8e3s4.b15(), _this__u8e3s4.b15().e1());
  }
    ...
    while (i < endIndex) {
      ...
      if (c < 128) {
        $l$block_0: {
          ...
          ctx.z17(tail, segmentOffset + _unary__edvuaz | 0, toByte(c));
          $l$loop: while (i < runLimit) {
            ...
            ctx.z17(tail, segmentOffset + _unary__edvuaz_0 | 0, toByte(c));
          }
          var bytesWritten = i + segmentOffset | 0;
          if (bytesWritten === 1) {
            tail.i15_1 = tail.i15_1 + bytesWritten | 0;
            var tmp = this_0;
            // Inline function 'kotlin.Long.plus' call
            var this_3 = this_0.a15_1;
            tmp.a15_1 = add(this_3, fromInt(bytesWritten));
            break $l$block_0;
          }
          // Inline function 'kotlin.check' call
          if (!(0 <= bytesWritten ? bytesWritten <= tail.m16() : false)) {
            var message = 'Invalid number of bytes written: ' + bytesWritten + '. Should be in 0..' + tail.m16();
            throw IllegalStateException_init_$Create$(toString(message));
          }
          if (!(bytesWritten === 0)) {
            tail.i15_1 = tail.i15_1 + bytesWritten | 0;
            var tmp_0 = this_0;
            // Inline function 'kotlin.Long.plus' call
            var this_4 = this_0.a15_1;
            tmp_0.a15_1 = add(this_4, fromInt(bytesWritten));
            break $l$block_0;
          }
          if (isEmpty(tail)) {
            this_0.b17();
        ...
        $l$block_2: {
          // Inline function 'kotlinx.io.unsafe.UnsafeBufferOperations.writeToTail' call
          var tail_0 = this_0.h16(2);
          get_SegmentWriteContextImpl().y17(tail_0, 0, toByte(c >> 6 | 192), toByte(c & 63 | 128));
          var bytesWritten_0 = 2;
          if (bytesWritten_0 === 2) {
            tail_0.i15_1 = tail_0.i15_1 + bytesWritten_0 | 0;
            var tmp_1 = this_0;
            // Inline function 'kotlin.Long.plus' call
            var this_5 = this_0.a15_1;
            tmp_1.a15_1 = add(this_5, fromInt(bytesWritten_0));
            break $l$block_2;
          }
          // Inline function 'kotlin.check' call
          if (!(0 <= bytesWritten_0 ? bytesWritten_0 <= tail_0.m16() : false)) {
            var message_0 = 'Invalid number of bytes written: ' + bytesWritten_0 + '. Should be in 0..' + tail_0.m16();
          ...
          if (!(bytesWritten_0 === 0)) {
            ...
            var tmp_2 = this_0;
            // Inline function 'kotlin.Long.plus' call
            var this_6 = this_0.a15_1;
            tmp_2.a15_1 = add(this_6, fromInt(bytesWritten_0));
            break $l$block_2;
          }
          if (isEmpty(tail_0)) {
            this_0.b17();
        ...
        $l$block_4: {
          // Inline function 'kotlinx.io.unsafe.UnsafeBufferOperations.writeToTail' call
          var tail_1 = this_0.h16(3);
          get_SegmentWriteContextImpl().x17(tail_1, 0, toByte(c >> 12 | 224), toByte(c >> 6 & 63 | 128), toByte(c & 63 | 128));
          var bytesWritten_1 = 3;
          if (bytesWritten_1 === 3) {
            tail_1.i15_1 = tail_1.i15_1 + bytesWritten_1 | 0;
            var tmp_3 = this_0;
            // Inline function 'kotlin.Long.plus' call
            var this_7 = this_0.a15_1;
            tmp_3.a15_1 = add(this_7, fromInt(bytesWritten_1));
            break $l$block_4;
          }
          // Inline function 'kotlin.check' call
          if (!(0 <= bytesWritten_1 ? bytesWritten_1 <= tail_1.m16() : false)) {
            var message_1 = 'Invalid number of bytes written: ' + bytesWritten_1 + '. Should be in 0..' + tail_1.m16();
            throw IllegalStateException_init_$Create$(toString(message_1));
          }
          if (!(bytesWritten_1 === 0)) {
            tail_1.i15_1 = tail_1.i15_1 + bytesWritten_1 | 0;
            var tmp_4 = this_0;
            // Inline function 'kotlin.Long.plus' call
            var this_8 = this_0.a15_1;
            tmp_4.a15_1 = add(this_8, fromInt(bytesWritten_1));
            break $l$block_4;
          }
          if (isEmpty(tail_1)) {
            this_0.b17();
        ...
        if (c > 56319 || !(56320 <= low ? low <= 57343 : false)) {
          ...
          this_0.v16(toByte(tmp$ret$29));
          i = i + 1 | 0;
        } else {
          var codePoint = 65536 + ((c & 1023) << 10 | low & 1023) | 0;
          $l$block_6: {
            // Inline function 'kotlinx.io.unsafe.UnsafeBufferOperations.writeToTail' call
            var tail_2 = this_0.h16(4);
            get_SegmentWriteContextImpl().w17(tail_2, 0, toByte(codePoint >> 18 | 240), toByte(codePoint >> 12 & 63 | 128), toByte(codePoint >> 6 & 63 | 128), toByte(codePoint & 63 | 128));
            var bytesWritten_2 = 4;
            if (bytesWritten_2 === 4) {
              tail_2.i15_1 = tail_2.i15_1 + bytesWritten_2 | 0;
              var tmp_6 = this_0;
              // Inline function 'kotlin.Long.plus' call
              var this_11 = this_0.a15_1;
              tmp_6.a15_1 = add(this_11, fromInt(bytesWritten_2));
              break $l$block_6;
            }
            // Inline function 'kotlin.check' call
            if (!(0 <= bytesWritten_2 ? bytesWritten_2 <= tail_2.m16() : false)) {
              var message_2 = 'Invalid number of bytes written: ' + bytesWritten_2 + '. Should be in 0..' + tail_2.m16();
            ...
            if (!(bytesWritten_2 === 0)) {
              ...
              var tmp_7 = this_0;
              // Inline function 'kotlin.Long.plus' call
              var this_12 = this_0.a15_1;
              tmp_7.a15_1 = add(this_12, fromInt(bytesWritten_2));
              break $l$block_6;
            }
            if (isEmpty(tail_2)) {
              this_0.b17();
  ...
  protoOf(SegmentReadContextImpl$1).z16 = function (segment, offset) {
    return segment.y15(offset);
  };
  function SegmentWriteContextImpl$1() {
  }
  protoOf(SegmentWriteContextImpl$1).z17 = function (segment, offset, value) {
    segment.s17(offset, value);
  };
  protoOf(SegmentWriteContextImpl$1).y17 = function (segment, offset, b0, b1) {
    segment.t17(offset, b0, b1);
  };
  protoOf(SegmentWriteContextImpl$1).x17 = function (segment, offset, b0, b1, b2) {
    segment.u17(offset, b0, b1, b2);
  };
  protoOf(SegmentWriteContextImpl$1).w17 = function (segment, offset, b0, b1, b2, b3) {
    segment.v17(offset, b0, b1, b2, b3);
  };
  function BufferIterationContextImpl$1() {
  }
  protoOf(BufferIterationContextImpl$1).z16 = function (segment, offset) {
    return get_SegmentReadContextImpl().z16(segment, offset);
  };
  ...
  protoOf(SegmentPool).k16 = function () {
    return Companion_instance.n17();
  };
  protoOf(SegmentPool).a17 = function (segment) {
  };
  ...
  protoOf(Buffer).o16 = write$default;
  //endregion
  //region block: init
