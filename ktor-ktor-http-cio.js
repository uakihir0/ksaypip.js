(function (factory) {
  ...
  function CIOMultipartDataBase(coroutineContext, channel, contentType, contentLength, formFieldLimit) {
    ...
    this.s2t_1 = coroutineContext;
    this.t2t_1 = null;
    this.u2t_1 = parseMultipart(this, channel, contentType, contentLength, formFieldLimit);
  }
  protoOf(CIOMultipartDataBase).n18 = function () {
    return this.s2t_1;
  };
  ...
  function thresholdReached($this) {
    return $this.w2t_1 >= $this.x2t_1 * 0.75;
  }
  function resize($this) {
    var prevSize = $this.w2t_1;
    var prevData = $this.y2t_1;
    $this.w2t_1 = 0;
    $this.x2t_1 = imul($this.x2t_1, 2) | 128;
    var tmp = $this;
    // Inline function 'kotlin.apply' call
    var this_0 = get_HeadersDataPool().e26();
    this_0.b2u(imul(prevData.a2u(), 2) | 1);
    tmp.y2t_1 = this_0;
    var _iterator__ex2g4s = prevData.c2u().t();
    while (_iterator__ex2g4s.u()) {
      var headerOffset = _iterator__ex2g4s.v();
      $this.e2u(prevData.d2u(headerOffset + 1 | 0), prevData.d2u(headerOffset + 2 | 0), prevData.d2u(headerOffset + 3 | 0), prevData.d2u(headerOffset + 4 | 0));
    }
    get_HeadersDataPool().f26(prevData);
    // Inline function 'kotlin.require' call
    // Inline function 'kotlin.require' call
    if (!(prevSize === $this.w2t_1)) {
      var message = 'Failed requirement.';
      throw IllegalArgumentException_init_$Create$(toString(message));
    }
  }
  function headerHasName($this, name, headerOffset) {
    var nameStartIndex = $this.y2t_1.d2u(headerOffset + 1 | 0);
    var nameEndIndex = $this.y2t_1.d2u(headerOffset + 2 | 0);
    return equalsLowerCase($this.v2t_1, nameStartIndex, nameEndIndex, name);
  }
  function HttpHeadersMap(builder) {
    this.v2t_1 = builder;
    this.w2t_1 = 0;
    this.x2t_1 = 0;
    this.y2t_1 = get_HeadersDataPool().e26();
  }
  protoOf(HttpHeadersMap).j28 = function (name) {
    if (this.w2t_1 === 0)
      return null;
    // Inline function 'kotlin.math.absoluteValue' call
    var this_0 = hashCodeLowerCase(name);
    var hash = abs(this_0);
    var headerIndex = hash % this.x2t_1 | 0;
    while (!(this.y2t_1.d2u(imul(headerIndex, 6) + 0 | 0) === -1)) {
      if (headerHasName(this, name, imul(headerIndex, 6))) {
        return this.f2u(imul(headerIndex, 6));
      }
      headerIndex = (headerIndex + 1 | 0) % this.x2t_1 | 0;
    }
    return null;
  };
  protoOf(HttpHeadersMap).g2u = function () {
    return this.y2t_1.c2u();
  };
  protoOf(HttpHeadersMap).e2u = function (nameStartIndex, nameEndIndex, valueStartIndex, valueEndIndex) {
    if (thresholdReached(this)) {
      resize(this);
    }
    // Inline function 'kotlin.math.absoluteValue' call
    var this_0 = hashCodeLowerCase(this.v2t_1, nameStartIndex, nameEndIndex);
    var hash = abs(this_0);
    var name = this.v2t_1.c(nameStartIndex, nameEndIndex);
    var headerIndex = hash % this.x2t_1 | 0;
    ...
    this.y2t_1.o2u(headerOffset + 0 | 0, hash);
    this.y2t_1.o2u(headerOffset + 1 | 0, nameStartIndex);
    this.y2t_1.o2u(headerOffset + 2 | 0, nameEndIndex);
    this.y2t_1.o2u(headerOffset + 3 | 0, valueStartIndex);
    this.y2t_1.o2u(headerOffset + 4 | 0, valueEndIndex);
    this.y2t_1.o2u(headerOffset + 5 | 0, -1);
    if (!(sameNameHeaderIndex === -1)) {
      this.y2t_1.o2u(imul(sameNameHeaderIndex, 6) + 5 | 0, headerIndex);
    }
    this.w2t_1 = this.w2t_1 + 1 | 0;
  };
  protoOf(HttpHeadersMap).p2u = function (headerOffset) {
    var nameStartIndex = this.y2t_1.d2u(headerOffset + 1 | 0);
    var nameEndIndex = this.y2t_1.d2u(headerOffset + 2 | 0);
    return this.v2t_1.c(nameStartIndex, nameEndIndex);
  };
  protoOf(HttpHeadersMap).f2u = function (headerOffset) {
    var valueStartIndex = this.y2t_1.d2u(headerOffset + 3 | 0);
    var valueEndIndex = this.y2t_1.d2u(headerOffset + 4 | 0);
    return this.v2t_1.c(valueStartIndex, valueEndIndex);
  };
  protoOf(HttpHeadersMap).q2u = function () {
    this.w2t_1 = 0;
    this.x2t_1 = 0;
    get_HeadersDataPool().f26(this.y2t_1);
    this.y2t_1 = get_HeadersDataPool().e26();
  };
  ...
  protoOf(HeadersData$headersStarts$slambda).f2v = function ($this$sequence, $completion) {
    var tmp = this.g2v($this$sequence, $completion);
    tmp.g8_1 = Unit_instance;
    tmp.h8_1 = null;
    return tmp.m8();
  };
  protoOf(HeadersData$headersStarts$slambda).z8 = function (p1, $completion) {
    return this.f2v(p1 instanceof SequenceScope ? p1 : THROW_CCE(), $completion);
  };
  protoOf(HeadersData$headersStarts$slambda).m8 = function () {
      ...
      try {
        ...
        switch (tmp) {
          ...
          case 1:
            ...
            this.d2v_1 = this.e2v_1.v();
            this.c2v_1 = 0;
            this.e8_1 = 2;
            continue $sm;
          case 2:
            if (!(this.c2v_1 < this.d2v_1.length)) {
              this.e8_1 = 5;
              continue $sm;
            }

            if (!(this.z2u_1.d2u(this.b2v_1 + 0 | 0) === -1)) {
              this.e8_1 = 3;
              suspendResult = this.a2v_1.ne(this.b2v_1, this);
          ...
          case 3:
            ...
            continue $sm;
          case 4:
            this.c2v_1 = this.c2v_1 + 6 | 0;
            this.b2v_1 = this.b2v_1 + 6 | 0;
            this.e8_1 = 2;
            continue $sm;
          case 5:
            this.e8_1 = 1;
  ...
  protoOf(HeadersData$headersStarts$slambda).g2v = function ($this$sequence, completion) {
    var i = new HeadersData$headersStarts$slambda(this.z2u_1, completion);
    i.a2v_1 = $this$sequence;
    return i;
  };
  function HeadersData$headersStarts$slambda_0(this$0, resultContinuation) {
    ...
    return constructCallableReference(function ($this$sequence, $completion) {
      return i.f2v($this$sequence, $completion);
    }, 1);
  }
  function HeadersData() {
    var tmp = this;
    // Inline function 'kotlin.collections.mutableListOf' call
    tmp.z2t_1 = ArrayList_init_$Create$();
  }
  protoOf(HeadersData).a2u = function () {
    return this.z2t_1.e1();
  };
  protoOf(HeadersData).b2u = function (subArraysCount) {
    ...
    if (inductionVariable < subArraysCount)
      do {
        ...
        this.z2t_1.b1(get_IntArrayPool().e26());
      }
       while (inductionVariable < subArraysCount);
  };
  protoOf(HeadersData).d2u = function (index) {
    return this.z2t_1.d1(index / 768 | 0)[index % 768 | 0];
  };
  protoOf(HeadersData).o2u = function (index, value) {
    this.z2t_1.d1(index / 768 | 0)[index % 768 | 0] = value;
  };
  protoOf(HeadersData).c2u = function () {
    return sequence(HeadersData$headersStarts$slambda_0(this, null));
  };
  protoOf(HeadersData).q2u = function () {
    var _iterator__ex2g4s = this.z2t_1.t();
    while (_iterator__ex2g4s.u()) {
      var array = _iterator__ex2g4s.v();
      get_IntArrayPool().f26(array);
    }
    this.z2t_1.r2();
  };
  function dumpTo(_this__u8e3s4, indent, out) {
    _init_properties_HttpHeadersMap_kt__hwatby();
    var _iterator__ex2g4s = _this__u8e3s4.g2u().t();
    while (_iterator__ex2g4s.u()) {
      var offset = _iterator__ex2g4s.v();
      out.c1(indent);
      out.c1(_this__u8e3s4.p2u(offset));
      out.c1(' => ');
      out.c1(_this__u8e3s4.f2u(offset));
      out.c1('\n');
    }
  }
  ...
  protoOf(IntArrayPool$1).x25 = function () {
    var tmp = 0;
  ...
  protoOf(IntArrayPool$1).k2v = function (instance) {
    fill(instance, -1);
    return protoOf(DefaultPool).c26.call(this, instance);
  };
  protoOf(IntArrayPool$1).c26 = function (instance) {
    return this.k2v(isIntArray(instance) ? instance : THROW_CCE());
  };
  function HeadersDataPool$1() {
    DefaultPool.call(this, 1000);
  }
  protoOf(HeadersDataPool$1).x25 = function () {
    return new HeadersData();
  };
  protoOf(HeadersDataPool$1).o2v = function (instance) {
    instance.q2u();
    return protoOf(DefaultPool).c26.call(this, instance);
  };
  protoOf(HeadersDataPool$1).c26 = function (instance) {
    return this.o2v(instance instanceof HeadersData ? instance : THROW_CCE());
  };
  ...
  function parseHeaderName(text, range) {
    _init_properties_HttpParser_kt__gbdom1();
    var index = range.c2w_1;
    var end = range.d2w_1;
    while (index < end) {
      var ch = text.b(index);
      if (ch === _Char___init__impl__6a9atx(58) && !(index === range.c2w_1)) {
        range.c2w_1 = index + 1 | 0;
        return index;
      }
      if (isDelimiter(ch)) {
        parseHeaderNameFailed(text, index, range.c2w_1, ch);
      }
      index = index + 1 | 0;
    }
  ...
  function parseHeaderValue(text, range) {
    ...
    range.c2w_1 = valueStart;
    range.d2w_1 = valueLastIndex + 1 | 0;
  }
  function validateHostHeader(host) {
    ...
    $l$block: {
      ...
      while (inductionVariable < charSequenceLength(host)) {
        ...
        inductionVariable = inductionVariable + 1 | 0;
        if (get_hostForbiddenSymbols().g2(new Char(element))) {
          tmp$ret$0 = true;
          break $l$block;
        }
      }
  ...
  function noColonFound(text, range) {
    _init_properties_HttpParser_kt__gbdom1();
    var tmp2 = range.c2w_1;
    // Inline function 'kotlin.text.substring' call
    var endIndex = range.d2w_1;
  ...
  protoOf($parseHeadersCOROUTINE$).m8 = function () {
    var suspendResult = this.g8_1;
    $sm: do
      try {
        var tmp = this.e8_1;
        switch (tmp) {
          case 0:
            this.f8_1 = 7;
            this.a2w_1 = new HttpHeadersMap(this.y2v_1);
            this.f8_1 = 6;
            this.e8_1 = 1;
            continue $sm;
          case 1:
            ...
            this.e8_1 = 2;
            suspendResult = readLineStrictTo(this.x2v_1, this.y2v_1, new Long(8192, 0), VOID, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 3:
            this.z2v_1.d2w_1 = this.y2v_1.n2u_1;
            this.b2w_1 = this.z2v_1.d2w_1 - this.z2v_1.c2w_1 | 0;
            if (this.b2w_1 === 0) {
              this.e8_1 = 5;
              continue $sm;
            } else {
          ...
          case 4:
            ...
            var nameStart = this.z2v_1.c2w_1;
            var nameEnd = parseHeaderName(this.y2v_1, this.z2v_1);
            var headerEnd = this.z2v_1.d2w_1;
            parseHeaderValue(this.y2v_1, this.z2v_1);
            var valueStart = this.z2v_1.c2w_1;
            var valueEnd = this.z2v_1.d2w_1;
            this.z2v_1.c2w_1 = headerEnd;
            this.a2w_1.e2u(nameStart, nameEnd, valueStart, valueEnd);
            this.e8_1 = 1;
            continue $sm;
          case 5:
            var host = this.a2w_1.j28('Host');
            if (!(host == null)) {
  ...
  function _init_properties_HttpParser_kt__gbdom1() {
    if (!properties_initialized_HttpParser_kt_uedryv) {
      ...
      httpLineEndings = LineEndingMode__plus_impl_ttpz2j(Companion_getInstance().j25_1, Companion_getInstance().i25_1);
      versions = Companion_instance.e2w(listOf(['HTTP/1.0', 'HTTP/1.1']));
    }
  }
  function get_CrLf() {
  ...
  function parseMultipart(_this__u8e3s4, input, contentType, contentLength, maxPartSize) {
    ...
    _init_properties_Multipart_kt__ato98a();
    if (!MultiPart_getInstance().k2g(contentType)) {
  ...
  function parseMultipart$slambda$slambda($firstBoundary, $countedInput, resultContinuation) {
    this.c2y_1 = $firstBoundary;
    this.d2y_1 = $countedInput;
    CoroutineImpl.call(this, resultContinuation);
  }
  protoOf(parseMultipart$slambda$slambda).f2y = function ($this$writer, $completion) {
    var tmp = this.g2y($this$writer, $completion);
    tmp.g8_1 = Unit_instance;
    tmp.h8_1 = null;
    return tmp.m8();
  };
  protoOf(parseMultipart$slambda$slambda).z8 = function (p1, $completion) {
    return this.f2y(p1 instanceof WriterScope ? p1 : THROW_CCE(), $completion);
  };
  protoOf(parseMultipart$slambda$slambda).m8 = function () {
    var suspendResult = this.g8_1;
    $sm: do
      try {
        var tmp = this.e8_1;
        switch (tmp) {
          case 0:
            this.f8_1 = 3;
            this.e8_1 = 1;
            suspendResult = parsePreambleImpl(this.c2y_1, this.d2y_1, this.e2y_1.l23_1, new Long(8193, 0), this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 1:
            this.e8_1 = 2;
            suspendResult = this.e2y_1.l23_1.r1v(this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
  ...
  protoOf(parseMultipart$slambda$slambda).g2y = function ($this$writer, completion) {
    var i = new parseMultipart$slambda$slambda(this.c2y_1, this.d2y_1, completion);
    i.e2y_1 = $this$writer;
    return i;
  };
  ...
  function parseMultipart$slambda($input, $boundaryPrefixed, $maxPartSize, $totalLength, resultContinuation) {
    this.p2y_1 = $input;
    this.q2y_1 = $boundaryPrefixed;
    this.r2y_1 = $maxPartSize;
    this.s2y_1 = $totalLength;
    CoroutineImpl.call(this, resultContinuation);
  }
  protoOf(parseMultipart$slambda).b2z = function ($this$produce, $completion) {
    var tmp = this.c2z($this$produce, $completion);
    tmp.g8_1 = Unit_instance;
    tmp.h8_1 = null;
    return tmp.m8();
  };
  protoOf(parseMultipart$slambda).z8 = function (p1, $completion) {
    return this.b2z((!(p1 == null) ? isInterface(p1, ProducerScope) : false) ? p1 : THROW_CCE(), $completion);
  };
  protoOf(parseMultipart$slambda).m8 = function () {
    var suspendResult = this.g8_1;
    $sm: do
      try {
        var tmp = this.e8_1;
        switch (tmp) {
          case 0:
            this.f8_1 = 25;
            this.u2y_1 = counted(this.p2y_1);
            this.v2y_1 = this.u2y_1.g25();
            this.z2y_1 = this.q2y_1.u14(get_PrefixString().e1());
            this.e8_1 = 1;
            suspendResult = readRemaining(writer(this.t2y_1, VOID, VOID, parseMultipart$slambda$slambda_0(this.z2y_1, this.u2y_1, null)).k1x_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 1:
            ...
            if (compare(get_remaining(preambleData), new Long(0, 0)) > 0) {
              this.e8_1 = 2;
              suspendResult = this.t2y_1.l1p(new Preamble(preambleData), this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
          ...
          case 4:
            if (!this.u2y_1.o1v()) {
              this.e8_1 = 5;
              suspendResult = skipIfFound(this.u2y_1, get_PrefixString(), this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
          ...
          case 6:
            ...
            this.e8_1 = 7;
            suspendResult = skipIfFound(this.u2y_1, get_CrLf(), this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 7:
            this.e8_1 = 8;
            suspendResult = skipIfFound(this.u2y_1, this.z2y_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 9:
            this.w2y_1 = new ByteChannel();
            this.y2y_1 = CompletableDeferred();
            var part = new MultipartPart(this.y2y_1, this.w2y_1);
            this.e8_1 = 10;
            suspendResult = this.t2y_1.l1p(part, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 10:
            ...
            this.f8_1 = 14;
            this.e8_1 = 11;
            suspendResult = parsePartHeadersImpl(this.u2y_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
            ...
            continue $sm;
          case 11:
            this.x2y_1 = suspendResult;
            if (!this.y2y_1.d1f(this.x2y_1)) {
              this.x2y_1.q2u();
              throw CancellationException_init_$Create$('Multipart processing has been cancelled');
            }

            this.e8_1 = 12;
            suspendResult = parsePartBodyImpl(this.q2y_1, this.u2y_1, this.w2y_1, this.x2y_1, this.r2y_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 14:
            ...
            if (tmp_0 instanceof Error) {
              var cause = this.h8_1;
              if (this.y2y_1.e1f(cause)) {
                var tmp0_safe_receiver = this.x2y_1;
                if (tmp0_safe_receiver == null)
                  null;
                else {
                  tmp0_safe_receiver.q2u();
                }
              }
              close(this.w2y_1, cause);
              throw cause;
            } else {
              throw this.h8_1;
            }
          ...
          case 17:
            if (!(this.s2y_1 == null)) {
              var consumedExceptEpilogue = subtract(this.u2y_1.g25(), this.v2y_1);
              var size = subtract(this.s2y_1, consumedExceptEpilogue);
              ...
              if (compare(size, new Long(0, 0)) > 0) {
                this.e8_1 = 21;
                suspendResult = readPacket(this.u2y_1, convertToInt(size), this);
                if (suspendResult === get_COROUTINE_SUSPENDED()) {
                  return suspendResult;
                }
                continue $sm;
              ...
              this.e8_1 = 18;
              suspendResult = readRemaining(this.u2y_1, this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
          ...
          case 18:
            ...
            if (!epilogueContent.c15()) {
              this.e8_1 = 19;
              suspendResult = this.t2y_1.l1p(new Epilogue(epilogueContent), this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
          ...
          case 21:
            ...
            this.e8_1 = 22;
            suspendResult = this.t2y_1.l1p(ARGUMENT_0, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
  ...
  protoOf(parseMultipart$slambda).c2z = function ($this$produce, completion) {
    var i = new parseMultipart$slambda(this.p2y_1, this.q2y_1, this.r2y_1, this.s2y_1, completion);
    i.t2y_1 = $this$produce;
    return i;
  };
  function parseMultipart$slambda_0($input, $boundaryPrefixed, $maxPartSize, $totalLength, resultContinuation) {
    ...
    return constructCallableReference(function ($this$produce, $completion) {
      return i.b2z($this$produce, $completion);
    }, 1);
  }
  ...
  protoOf($parsePartHeadersImplCOROUTINE$).m8 = function () {
    var suspendResult = this.g8_1;
    $sm: do
      try {
        var tmp = this.e8_1;
        switch (tmp) {
          case 0:
            this.f8_1 = 3;
            this.s2w_1 = new CharArrayBuilder();
            this.f8_1 = 2;
            this.e8_1 = 1;
            suspendResult = parseHeaders(this.r2w_1, this.s2w_1, VOID, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
  ...
  function $parsePartBodyImplCOROUTINE$(boundaryPrefixed, input, output, headers, limit, resultContinuation) {
    CoroutineImpl.call(this, resultContinuation);
    this.b2x_1 = boundaryPrefixed;
    this.c2x_1 = input;
    this.d2x_1 = output;
    this.e2x_1 = headers;
    this.f2x_1 = limit;
  }
  protoOf($parsePartBodyImplCOROUTINE$).m8 = function () {
    var suspendResult = this.g8_1;
    $sm: do
      try {
        var tmp = this.e8_1;
        switch (tmp) {
          case 0:
            this.f8_1 = 6;
            var tmp0_safe_receiver = this.e2x_1.j28('Content-Length');
            var contentLength = tmp0_safe_receiver == null ? null : parseDecLong(tmp0_safe_receiver);
            if (contentLength == null) {
              this.e8_1 = 3;
              suspendResult = readUntil(this.c2x_1, this.b2x_1, this.d2x_1, this.f2x_1, true, this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
            } else {
              var containsUpper = this.f2x_1;
              if (compare(new Long(0, 0), contentLength) <= 0 ? compare(contentLength, containsUpper) <= 0 : false) {
                this.e8_1 = 1;
                suspendResult = copyTo(this.c2x_1, this.d2x_1, contentLength, this);
                if (suspendResult === get_COROUTINE_SUSPENDED()) {
                  return suspendResult;
                }
                continue $sm;
                ...
                var tmp_0 = this;
                throwLimitExceeded(contentLength, this.f2x_1);
              }
            }

            break;
          case 1:
            this.i2x_1 = suspendResult;
            this.e8_1 = 2;
            suspendResult = skipIfFoundReadCount(this.c2x_1, this.b2x_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 2:
            var ARGUMENT = suspendResult;
            this.h2x_1 = add(this.i2x_1, ARGUMENT);
            this.e8_1 = 4;
            continue $sm;
          case 3:
            ...
            continue $sm;
          case 4:
            this.g2x_1 = this.h2x_1;
            this.e8_1 = 5;
            suspendResult = this.d2x_1.i1v(this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
  ...
  function $skipIfFoundReadCountCOROUTINE$(_this__u8e3s4, prefix, resultContinuation) {
    CoroutineImpl.call(this, resultContinuation);
    this.r2x_1 = _this__u8e3s4;
    this.s2x_1 = prefix;
  }
  protoOf($skipIfFoundReadCountCOROUTINE$).m8 = function () {
    var suspendResult = this.g8_1;
    $sm: do
      try {
        var tmp = this.e8_1;
        switch (tmp) {
          case 0:
            this.f8_1 = 3;
            this.e8_1 = 1;
            suspendResult = skipIfFound(this.r2x_1, this.s2x_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 1:
            if (suspendResult) {
              var tmp_0 = this;
              tmp_0.t2x_1 = fromInt(this.s2x_1.e1());
              this.e8_1 = 2;
              continue $sm;
            } else {
              var tmp_1 = this;
              tmp_1.t2x_1 = new Long(0, 0);
              this.e8_1 = 2;
              continue $sm;
            }
  ...
  protoOf(Companion).e2w = function (from) {
    var tmp = AsciiCharTree$Companion$build$lambda;
    return this.h2z(from, tmp, AsciiCharTree$Companion$build$lambda_0);
  };
  protoOf(Companion).h2z = function (from, length, charAt) {
    var tmp$ret$0;
    $l$block_0: {
  ...
  function getImpl($this, index) {
    return bufferForIndex($this, index)[index % ensureNotNull($this.j2u_1).length | 0];
  }
  ...
  protoOf(SubSequenceImpl).a = function () {
    return this.k2z_1 - this.j2z_1 | 0;
  };
  protoOf(SubSequenceImpl).b = function (index) {
    var withOffset = index + this.j2z_1 | 0;
    // Inline function 'kotlin.require' call
    if (!(index >= 0)) {
  ...
  protoOf(SubSequenceImpl).c = function (startIndex, endIndex) {
    ...
    // Inline function 'kotlin.require' call
    if (!(endIndex <= (this.k2z_1 - this.j2z_1 | 0))) {
      var message_1 = 'end should be less than length (' + this.a() + ')';
      throw IllegalArgumentException_init_$Create$(toString(message_1));
    }
    if (startIndex === endIndex)
      return '';
    return new SubSequenceImpl(this.m2z_1, this.j2z_1 + startIndex | 0, this.j2z_1 + endIndex | 0);
  };
  protoOf(SubSequenceImpl).toString = function () {
    ...
    if (tmp0_elvis_lhs == null) {
      ...
      var this_0 = toString(copy(this.m2z_1, this.j2z_1, this.k2z_1));
      this.l2z_1 = this_0;
      tmp = this_0;
    } else {
      tmp = tmp0_elvis_lhs;
  ...
  protoOf(SubSequenceImpl).equals = function (other) {
    ...
    if (!(charSequenceLength(other) === this.a()))
      return false;
    return rangeEqualsImpl(this.m2z_1, this.j2z_1, other, 0, this.a());
  };
  protoOf(SubSequenceImpl).hashCode = function () {
    var tmp0_safe_receiver = this.l2z_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : getStringHashCode(tmp0_safe_receiver);
    return tmp1_elvis_lhs == null ? hashCodeImpl(this.m2z_1, this.j2z_1, this.k2z_1) : tmp1_elvis_lhs;
  };
  function bufferForIndex($this, index) {
    ...
    return list.d1(index / ensureNotNull($this.j2u_1).length | 0);
  }
  ...
  function nonFullBuffer($this) {
    return $this.m2u_1 === 0 ? appendNewArray($this) : ensureNotNull($this.j2u_1);
  }
  function appendNewArray($this) {
    var newBuffer = $this.h2u_1.e26();
    var existing = $this.j2u_1;
    $this.j2u_1 = newBuffer;
    $this.m2u_1 = newBuffer.length;
    $this.l2u_1 = false;
    if (!(existing == null)) {
      var tmp0_elvis_lhs = $this.i2u_1;
      var tmp;
      if (tmp0_elvis_lhs == null) {
        // Inline function 'kotlin.also' call
  ...
  function currentPosition($this) {
    return ensureNotNull($this.j2u_1).length - $this.m2u_1 | 0;
  }
  ...
  protoOf(CharArrayBuilder).b = function (index) {
    ...
    // Inline function 'kotlin.require' call
    if (!(index < this.n2u_1)) {
      var message_0 = 'index ' + index + ' is not in range [0, ' + this.n2u_1 + ')';
      throw IllegalArgumentException_init_$Create$(toString(message_0));
    }
  ...
  protoOf(CharArrayBuilder).c = function (startIndex, endIndex) {
    ...
    // Inline function 'kotlin.require' call
    if (!(endIndex <= this.n2u_1)) {
      var message_1 = 'endIndex (' + endIndex + ') is greater than length (' + this.n2u_1 + ')';
      throw IllegalArgumentException_init_$Create$(toString(message_1));
    }
    return new SubSequenceImpl(this, startIndex, endIndex);
  };
  protoOf(CharArrayBuilder).toString = function () {
    var tmp0_elvis_lhs = this.k2u_1;
    var tmp;
    if (tmp0_elvis_lhs == null) {
      // Inline function 'kotlin.also' call
      var this_0 = toString(copy(this, 0, this.n2u_1));
      this.k2u_1 = this_0;
      tmp = this_0;
    } else {
      tmp = tmp0_elvis_lhs;
  ...
  protoOf(CharArrayBuilder).equals = function (other) {
    if (!(!(other == null) ? isCharSequence(other) : false))
      return false;
    if (!(this.n2u_1 === charSequenceLength(other)))
      return false;
    return rangeEqualsImpl(this, 0, other, 0, this.n2u_1);
  };
  protoOf(CharArrayBuilder).hashCode = function () {
    var tmp0_safe_receiver = this.k2u_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : getStringHashCode(tmp0_safe_receiver);
    return tmp1_elvis_lhs == null ? hashCodeImpl(this, 0, this.n2u_1) : tmp1_elvis_lhs;
  };
  protoOf(CharArrayBuilder).s = function (value) {
    nonFullBuffer(this)[ensureNotNull(this.j2u_1).length - this.m2u_1 | 0] = value;
    this.k2u_1 = null;
    this.m2u_1 = this.m2u_1 - 1 | 0;
    this.n2u_1 = this.n2u_1 + 1 | 0;
    return this;
  };
  protoOf(CharArrayBuilder).vb = function (value, startIndex, endIndex) {
    if (value == null)
      return this;
    var current = startIndex;
    while (current < endIndex) {
      var buffer = nonFullBuffer(this);
      var offset = buffer.length - this.m2u_1 | 0;
      ...
      this.m2u_1 = this.m2u_1 - bytesToCopy | 0;
    }
    this.k2u_1 = null;
    this.n2u_1 = this.n2u_1 + (endIndex - startIndex | 0) | 0;
    return this;
  };
  protoOf(CharArrayBuilder).c1 = function (value) {
    if (value == null)
      return this;
    return this.vb(value, 0, charSequenceLength(value));
  };
  protoOf(CharArrayBuilder).q2u = function () {
    var list = this.i2u_1;
    if (!(list == null)) {
      this.j2u_1 = null;
      var inductionVariable = 0;
      ...
      if (tmp0_safe_receiver == null)
        ...
        // Inline function 'kotlin.let' call
        this.h2u_1.f26(tmp0_safe_receiver);
      }
      this.j2u_1 = null;
    }
    this.l2u_1 = true;
  ...
  protoOf(CharArrayPool$1).e26 = function () {
    return charArray(2048);
  };
  function CharArrayPool$2() {
    DefaultPool.call(this, 4096);
  }
  protoOf(CharArrayPool$2).x25 = function () {
    return charArray(2048);
  };
  ...
  function DefaultHttpMethods$lambda(it) {
    _init_properties_Chars_kt__d3i39x();
    return it.b2m_1.length;
  }
  function DefaultHttpMethods$lambda_0(m, idx) {
    _init_properties_Chars_kt__d3i39x();
    return new Char(charCodeAt(m.b2m_1, idx));
  }
  ...
  function _init_properties_Chars_kt__d3i39x() {
    if (!properties_initialized_Chars_kt_phjfhp) {
      ...
      var tmp_0 = Companion_getInstance_0().a2m_1;
      var tmp_1 = DefaultHttpMethods$lambda;
      DefaultHttpMethods = tmp.h2z(tmp_0, tmp_1, DefaultHttpMethods$lambda_0);
  ...
  protoOf(MutableRange).toString = function () {
    return 'MutableRange(start=' + this.c2w_1 + ', end=' + this.d2w_1 + ')';
  };
