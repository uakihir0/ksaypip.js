(function (factory) {
  ...
  var toCharArray = kotlin_kotlin.$_$.wd;
  ...
  function Companion() {
    ...
    this.o14_1 = new ByteString(new Int8Array(0), null);
    this.p14_1 = toCharArray('0123456789abcdef');
  }
  protoOf(Companion).q14 = function (byteArray) {
  ...
  protoOf(ByteString).equals = function (other) {
    ...
    if (!(other instanceof ByteString))
      THROW_CCE();
    if (!(other.r14_1.length === this.r14_1.length))
      return false;
    if (!(other.s14_1 === 0) && !(this.s14_1 === 0) && !(other.s14_1 === this.s14_1))
      return false;
    return contentEquals(this.r14_1, other.r14_1);
  };
  protoOf(ByteString).hashCode = function () {
    var hc = this.s14_1;
    if (hc === 0) {
      hc = contentHashCode(this.r14_1);
      this.s14_1 = hc;
    }
    return hc;
  };
  protoOf(ByteString).d1 = function (index) {
    ...
    return this.r14_1[index];
  };
  protoOf(ByteString).t14 = function (startIndex, endIndex) {
    var tmp;
    if (startIndex === endIndex) {
      tmp = Companion_getInstance().o14_1;
    } else {
      tmp = ByteString_init_$Create$(this.r14_1, startIndex, endIndex);
    }
    return tmp;
  };
  protoOf(ByteString).u14 = function (startIndex, endIndex, $super) {
    endIndex = endIndex === VOID ? this.e1() : endIndex;
    return $super === VOID ? this.t14(startIndex, endIndex) : $super.t14.call(this, startIndex, endIndex);
  };
  protoOf(ByteString).v14 = function (other) {
    if (other === this)
      return 0;
    var localData = this.r14_1;
    var otherData = other.r14_1;
  ...
  protoOf(ByteString).d = function (other) {
    return this.v14(other instanceof ByteString ? other : THROW_CCE());
  };
  protoOf(ByteString).toString = function () {
    ...
    if (inductionVariable < last)
      do {
        ...
        inductionVariable = inductionVariable + 1 | 0;
        var b = localData[i];
        $this$with.s(Companion_getInstance().p14_1[(b >>> 4 | 0) & 15]);
        $this$with.s(Companion_getInstance().p14_1[b & 15]);
      }
       while (inductionVariable < last);
    return $this$with.s(_Char___init__impl__6a9atx(41)).toString();
  };
  protoOf(ByteString).w14 = function () {
    return this.r14_1;
  };
  function ByteString_0(bytes) {
    ...
    if (bytes.length === 0) {
      ...
      tmp = Companion_getInstance().q14(bytes);
    }
    return tmp;
  }
  function decodeToString_0(_this__u8e3s4) {
    return decodeToString(_this__u8e3s4.w14());
  }
  ...
  protoOf(UnsafeByteStringOperations).x14 = function (array) {
    return Companion_getInstance().q14(array);
  };
